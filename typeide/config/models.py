...
class SideBar(models.Model):
    ...
    title = models.CharField(max_length=50, verbose_name='标题')
    display_type = models.PositiveIntegerField(default=STATUS_SHOW,choices=SID_TYPE,)
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE,verbose_name='作者')
    created_time = created_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
